                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <ul class="footer-address-list ftr-details">
                            <li>
                                ...
                                <p>Email <span> <a href="mailto:info@trinity-info-pvt-ltd.com">info@trinity-info-pvt-ltd.com</a></span></p>
                            </li>
                            <li>
                                <span><i class="fas fa-phone-alt"></i></span>
                                <p>Phone <span> <a href="tel:+918072034933">+91 80720 34933</a></span></p>
                            </li>
                            <li>
                                <span><i class="fas fa-map-marker-alt"></i></span>
                                <p>Address <span> 83, Simpson Nagar, Sivaji Colony, Edayarpalayam (Post) Coimbatore, Tamil Nadu 641025, India</span></p>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="footer-">
                                <p>Copyright &copy; 2020 Trinity Info. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
