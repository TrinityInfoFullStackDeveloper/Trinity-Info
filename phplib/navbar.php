            ...
            <div class="menu-header">
                ...
                <div class="custom-nav" role="navigation">
                    <ul class="nav-list">
                                            ...
                                            <div class="sub-menu-center-block">
                                                ...
                                                <div class="sub-menu-column">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="#" class="disabled">Print & Packaging Design</a> </li>
                        ...
                        <li><a href="portfolio-block.html" class="menu-links">Portfolio</a> </li>
                        <!--menu right border-->
                        <li><a href="get-quote.html" class="menu-links right-bddr">Contact</a> </li>
                                ...
                                <div class="contact-info-">
                                    ...
                                    <div class="inquiry-card-nn">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class="fab fa-whatsapp"></i><a href="javascript:void(0)">trinity.info.company</a></li>
                                            <li><i class="fas fa-envelope"></i><a href="mailto:info@trinity-info-pvt-ltd.com">info@trinity-info-pvt-ltd.com</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li><a href="#">Home</a>
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li><a href="index.html">Digital Agency <span class="badge badge-warning">New</span></a></li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="index-dark.html">Digital Agency <span class="badge badge-warning">New</span></a></li>
